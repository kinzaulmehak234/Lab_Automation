    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-sidebar sidebar-style-2 bg-dark" >
        <aside id="sidebar-wrapper">
          ...
          <li><a class="nav-link" href="{{url('/admin')}}"><i class="fas fa-fire"></i> <span>Dashboard</span></a></li>
          <li><a class="nav-link" href="{{url('/admin/products')}}"><i class="fas fa-fire"></i> <span>Manage Product</span></a></li>
          <li><a class="nav-link" href="{{url('/admin/tests')}}"><i class="fas fa-fire"></i> <span>Manage Test</span></a></li>
          <li><a class="nav-link" href="{{url('/admin/userlist')}}"><i class="fas fa-fire"></i> <span>User List</span></a></li>
          <li><a class="nav-link" href="{{url('/admin/contact')}}"><i class="fas fa-fire"></i> <span>Contact List</span></a></li>
      ...
      <footer class="main-footer">
        <div class="footer-left">
           &copy; 2024 <div class="bullet"></div> Design By <a href="https://nauval.in/">Kinza-Ul-Mehak&Tania</a>
        </div>
